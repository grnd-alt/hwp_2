...
def plotAllXYfrom3(filenames):
    ...
    plt.xlabel("Source Drain Spannung")
    plt.ylabel("Drain Strom")
    plt.legend()
    plt.show()
if __name__ == "__main__":
    plotAllXYfrom3(['./hwp_2/6.4/dataMos0.txt','./hwp_2/6.4/dataMos1.txt','./hwp_2/6.4/dataMos2.txt','./hwp_2/6.4/dataMos3.txt','./hwp_2/6.4/dataMos25.txt','./hwp_2/6.4/dataMos4.txt','./hwp_2/6.4/dataMos5.txt'])