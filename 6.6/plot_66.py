...
def plotAllXYfrom3(filenames):
    ...
    plt.xlabel("input Spannung")
    plt.ylabel("Strom über GS")
    plt.legend()
    plt.show()
if __name__ == "__main__":
    plotAllXYfrom3(['./hwp_2/6.6/dataMos5.txt','./hwp_2/6.6/dataMos4.txt','./hwp_2/6.6/dataMos3.txt','./hwp_2/6.6/dataMos2.txt'])